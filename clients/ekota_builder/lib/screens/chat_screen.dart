...
class BuilderChatScreen extends StatefulWidget {
  final SyndicateThreadModel thread;

  const BuilderChatScreen({super.key, required this.thread});

  @override
  State<BuilderChatScreen> createState() => _BuilderChatScreenState();
}

class _BuilderChatScreenState extends State<BuilderChatScreen> {
  ...
  Future<void> _initChatSession() async {
    ...
    _authToken = prefs.getString('jwt') ?? prefs.getString('auth_token') ?? 'dev-token';
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      CircleAvatar(
                        radius: 3,
                        backgroundColor: _isConnected ? Colors.greenAccent : Colors.amber,
                      ),
            ...
            Container(
              ...
              child: const Row(
                children: [
                  ...
                  SizedBox(width: 8),
                  Text(
                    'Reconnecting to split-buying chat...',
                ...
                : _messages.isEmpty
                    ...
                    : NotificationListener<ScrollNotification>(
                        ...
                        child: ListView.builder(
                          key: const PageStorageKey('builder_chat_messages_scroll'),
  ...
  Widget _buildMessageTile(ChatMessageModel msg, bool isMe) {
    ...
    return Align(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isMe ? AppColors.dark : Colors.white,
                ...
                child: ClipRRect(
                  ...
                  child: Image.network(
                    ...
                    errorBuilder: (_, __, ___) => Container(
                      ...
                      child: const Row(
                        children: [
                          Icon(Icons.insert_drive_file, color: AppColors.accent),
                          SizedBox(width: 8),
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const Text(
            'No messages yet in this split-buying thread.',
                ...
                child: Row(
                  children: [
                    if (isImage && _selectedFileBytes != null)
                      ...
                      const Icon(Icons.insert_drive_file, color: AppColors.accent, size: 28),
