...
import 'producer_withdrawal_screen.dart';
...
class _WalletScreenState extends State<WalletScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Builder Wallet'),
        backgroundColor: AppColors.dark,
                        ...
                        Expanded(
                          child: OutlinedButton.icon(
                            onPressed: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(builder: (_) => const ProducerWithdrawalScreen()),
                              ).then((_) => _loadWalletData());
                            },
                        ...
                        subtitle: Column(
                          ...
                          children: [
                            ...
                            if (tx.statusSubtitle.isNotEmpty) ...[
                              const SizedBox(height: 2),
                              Text(tx.statusSubtitle, style: const TextStyle(fontSize: 11, color: AppColors.textMuted)),
                            ],
                            const SizedBox(height: 2),
