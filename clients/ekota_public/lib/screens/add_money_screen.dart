...
class _AddMoneyScreenState extends State<AddMoneyScreen> {
  ...
  final List<double> _presetAmounts = [500, 1000, 5000, 10000];
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    const Row(
                      children: [
                        Icon(Icons.account_balance_wallet, color: Color(0xFF6C63FF), size: 24),
                        SizedBox(width: 10),
                        Text(
                    ...
                    const Text(
                      'Deposit money into your Public Rental Wallet via bKash, Nagad, Cards, or Net Banking.',
                    ...
                    Wrap(
                      ...
                      children: _presetAmounts.map((amt) {
                        ...
                        return ActionChip(
                          ...
                          backgroundColor: isSelected ? const Color(0xFFEDE9FE) : const Color(0xFFF1F5F9),
                          side: BorderSide(
