...
class PublicChatListScreen extends StatefulWidget {
  const PublicChatListScreen({super.key});

  @override
  State<PublicChatListScreen> createState() => _PublicChatListScreenState();
}

class _PublicChatListScreenState extends State<PublicChatListScreen> {
                                  ...
                                  children: [
                                    CircleAvatar(
                                      ...
                                      child: thread.imageUrls.isEmpty
                                          ? const Icon(Icons.chat_bubble_rounded, color: Color(0xFF6C63FF), size: 26)
                                          : null,
                                    ),
                                    Positioned(
                                      right: 0,
