...
class PublicChatScreen extends StatefulWidget {
  ...
  const PublicChatScreen({super.key, required this.thread});
                ...
                : _messages.isEmpty
                    ...
                    : NotificationListener<ScrollNotification>(
                        ...
                        child: ListView.builder(
                          key: const PageStorageKey('public_chat_messages_scroll'),
                ...
                child: Row(
                  children: [
                    if (isImage && _selectedFileBytes != null)
                      ...
                      const Icon(Icons.insert_drive_file, color: Color(0xFF6C63FF), size: 28),
