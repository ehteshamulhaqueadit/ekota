                    ...
                    child: OutlinedButton.icon(
                      onPressed: () {
                        final thread = SyndicateThreadModel(
                          id: item['id'] ?? '20000000-0000-0000-0000-000000000001',
                          assetName: item['assetName'] ?? 'Asset Listing',
                          category: item['category'] ?? 'General',
                          fundingTarget: (item['fundingTarget'] ?? 250000).toDouble(),
                          rentalPrice: price,
                          currentFunding: (item['currentFunding'] ?? 187500).toDouble(),
                          fundingPercentage: (item['fundingPercentage'] ?? 75).toInt(),
                          imageUrls: imageUrls,
                          producerName: item['producerName'] ?? 'Producer',
                          status: item['status'] ?? 'active',
                        );
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (_) => PublicChatScreen(thread: thread),
                          ),
                        );
                      },
                      icon: const Icon(Icons.forum_outlined, color: Color(0xFF6C63FF)),
                      label: const Text(
                        'Join Co-Owner Chat Thread',
                        style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: Color(0xFF6C63FF)),
                      ),
