...
class PublicWithdrawalScreen extends StatefulWidget {
  const PublicWithdrawalScreen({super.key});

  @override
  State<PublicWithdrawalScreen> createState() => _PublicWithdrawalScreenState();
}

class _PublicWithdrawalScreenState extends State<PublicWithdrawalScreen> {
  final _withdrawAmountController = TextEditingController(text: '1000');
  ...
  Future<void> _loadData() async {
    try {
      ...
      final balData = await service.fetchBalance();
      final list = await service.fetchMyRequests();
      ...
      appBar: AppBar(
        title: const Column(
          ...
          children: [
            ...
            Text('Transfer wallet balance to bank or mobile wallet', style: TextStyle(fontSize: 11, color: Colors.white70, fontWeight: FontWeight.normal)),
          ],
        ),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // Withdrawal Request History List
