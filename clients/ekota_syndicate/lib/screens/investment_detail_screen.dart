          ...
          : SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Action buttons
                  _actionButton(Icons.forum_outlined, 'Join Syndicate Co-Owner Chat', () {
                    final thread = SyndicateThreadModel(
                      id: widget.listingId,
                      assetName: listing['assetName'] ?? 'Investment Asset',
                      category: 'Asset Syndicate',
                      fundingTarget: (listing['fundingTarget'] ?? 250000).toDouble(),
                      rentalPrice: 1500,
                      currentFunding: (listing['currentFunding'] ?? 187500).toDouble(),
                      fundingPercentage: (listing['fundingPercentage'] ?? 75).toInt(),
                      imageUrls: [],
