          ...
          child: Card(
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  const Text('Ekota Syndicate', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),
          ...
          child: Card(
            child: Padding(
              ...
              child: Column(
                mainAxisSize: MainAxisSize.min,
                children: [
                  const Text('Create Investor Account', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),
                  const SizedBox(height: 20),
